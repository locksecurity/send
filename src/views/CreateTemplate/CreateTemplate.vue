  ...
  <form method="post" @submit.prevent="saveTemplate" class="mx-auto max-w-3xl sm:px-6 lg:px-8">
    <div class="mt-12">
        ...
        <div class="border-b border-gray-900/10 pb-10">
          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                <textarea v-model="description" id="template-description" name="about" rows="2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" />
              </div>
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6">
        ...
        <loadable-button :loading="submitting" type="submit" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Save</loadable-button>
      </div>
    </div>
  </form>
</template>
