  ...
  <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
    ...
    <main class="py-10 lg:pt-16">
      <div v-if="!list.length" class="text-center px-2">
        ...
        <div class="mt-6">
          <router-link to="/templates/new" type="button" class="inline-flex items-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
